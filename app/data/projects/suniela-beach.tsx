    ...
    return (
      <div>
        ...
        <p>
          ...
          To create a visual identity that matched this, the majority of the
          site incorporates these arches. In fact, all the angles used come
          straight from their logo, helping to make the site match the rest of
          Suniela's incredible branding.
        </p>
        ...
        <p>
          ...
          interface, and a better shopping experience
        </p>
