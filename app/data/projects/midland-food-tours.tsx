    ...
    return (
      <div>
        ...
        <p>
          ...
          across Canada, the United States, and even Cartagena, Columbia.
          She&apos;s used her background in tourism and hospitality and her 20+
          years as an educator to create one of the best culinary tours around.
        </p>
        <h3>Project</h3>
        <p>
        ...
        <p>
          With a food tour you can expect to eat, that&apos;s a given. I wanted
          the photos and videos to go beyond that. MFT is about making a
          connection with Midland, Ontario and the charm that this small town
          has to offer. From the waterfront to the many murals. I put these
          murals front and centre, to help potential customers feel a sense of
          place.
        </p>
        <Image
        ...
        <h3>Results</h3>
        <p>
          There&apos;s countless other aspects to the design that I could talk
          ...
          stand out. Take a look at their website and then reach out once
          you&apos;re ready.
        </p>
